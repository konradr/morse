...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25397__auto__,writer__25398__auto__,opt__25399__auto__){
return cljs.core._write(writer__25398__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__36819 = o;
(G__36819[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__36821__i < G__36821__a.length) {G__36821__a[G__36821__i] = arguments[G__36821__i + 0]; ++G__36821__i;}
  args = new cljs.core.IndexedSeq(G__36821__a,0);
} 
...
if(cljs.core.truth_((function (){var and__24779__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__24779__auto__){
var and__24779__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__36828 = jsprops;
(G__36828["defaultValue"] = value);

(G__36828["onChange"] = ((function (G__36828,v,value,on_change){
return (function (p1__36825_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36825_SHARP_);
});})(G__36828,v,value,on_change))
);

(G__36828["ref"] = ((function (G__36828,v,value,on_change){
return (function (p1__36826_SHARP_){
return (this$["cljsInputElement"] = p1__36826_SHARP_);
});})(G__36828,v,value,on_change))
);
...
var vec__36835 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36835,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36835,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36835,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___36840 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___36840 == null)){
} else {
var key_36841 = temp__4661__auto___36840;
...
var G__36843 = (new reagent.impl.template.NativeWrapper());
(G__36843["name"] = c);
...
var G__36845 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36845) : reagent.impl.template.as_element.call(null,G__36845));
} else {
...
var len__25866__auto___36851 = arguments.length;
var i__25867__auto___36852 = (0);
while(true){
if((i__25867__auto___36852 < len__25866__auto___36851)){
args__25873__auto__.push((arguments[i__25867__auto___36852]));

var G__36853 = (i__25867__auto___36852 + (1));
i__25867__auto___36852 = G__36853;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25874__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36849){
var G__36850 = cljs.core.first(seq36849);
var seq36849__$1 = cljs.core.next(seq36849);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__36850,seq36849__$1);
});
...
break;
default:
var G__36857 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__36857;
continue;
...
var n__25706__auto___36860 = a.length;
var i_36861 = (0);
while(true){
if((i_36861 < n__25706__auto___36860)){
(a[i_36861] = reagent.impl.template.as_element((a[i_36861])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__25706__auto___36863 = a.length;
var i_36864 = (0);
while(true){
if((i_36864 < n__25706__auto___36863)){
var val_36865 = (a[i_36864]);
if((cljs.core.vector_QMARK_(val_36865)) && ((reagent.impl.template.key_from_vec(val_36865) == null))){
(o["no-key"] = true);
} else {
}

(a[i_36864] = reagent.impl.template.as_element(val_36865));

var G__36866 = (i_36864 + (1));
i_36864 = G__36866;
continue;
} else {
}
...
var ctx = ({});
var vec__36870 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36870,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36870,(1),null);
...
var G__36874 = (cljs.core.count(argv) - first_child);
switch (G__36874) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__36874){
