...
var map__39098 = top_item;
var map__39098__$1 = ((((!((map__39098 == null)))?((((map__39098.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39098.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39098):map__39098);
var file = cljs.core.get.call(null,map__39098__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__39098__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39098__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e39097){var _e = e39097;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39100 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39100)){
var seen_errors_39101 = temp__4655__auto___39100;
if(cljs.core.truth_(seen_errors_39101.has(self))){
} else {
seen_errors_39101.add(self);

var temp__4657__auto___39102 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39102)){
var sense_39103 = temp__4657__auto___39102;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_39103)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1478292557752