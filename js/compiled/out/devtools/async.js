...
var o__36176__auto___39071 = (function (){var o__36176__auto__ = (function (){var o__36176__auto__ = Promise;
return goog.object.get(o__36176__auto__,"resolve").call(o__36176__auto__);
})();
return goog.object.get(o__36176__auto__,"then").call(o__36176__auto__,callback);
})();
goog.object.get(o__36176__auto___39071,"catch").call(o__36176__auto___39071,devtools.async.rethrow_outside_promise);
...
var G__39073_39074 = Error;
var target__36195__auto___39075 = G__39073_39074;
if(cljs.core.truth_(target__36195__auto___39075)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__39073_39074)].join('')),cljs.core.str("\n"),cljs.core.str("target__36195__auto__")].join('')));
}

goog.object.set(target__36195__auto___39075,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1478292557614